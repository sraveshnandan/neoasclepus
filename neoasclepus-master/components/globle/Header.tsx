...
const Header = () => {
    ...
    return (
        <header className="flex py-2 bg-transparent/10 border-b-[1px] border-b-gray-200  lg:px-16 md:px-4 px-4 sticky top-0 z-10 backdrop-blur-md w-full items-center justify-between">
